...
export default class NewsletterEmails {
  static subscribeEmail(email: string): string {
    const body = `
      <h1 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#111111;">¡Ya estás suscrito!</h1>
      <p style="margin:0 0 20px;font-size:15px;color:#4d535e;line-height:1.6;">
        <strong>${email}</strong> está ahora suscrito al boletín de EduGreen.
        Recibirás novedades sobre nuevas funciones, recursos educativos y noticias de la plataforma.
      </p>
        ...
        <tr>
          <td style="background:#f0fdf4;border-radius:10px;padding:20px 24px;border-left:4px solid #12ea36;">
            <p style="margin:0;font-size:14px;color:#4d535e;line-height:1.6;">
              ¿Quieres darte de baja en cualquier momento? Puedes hacerlo desde la plataforma EduGreen.
            </p>
          </td>
        </tr>
      </table>
      ...
      <p style="margin:0;font-size:12px;color:#9ca3af;">Si no te has suscrito, puedes ignorar este correo.</p>
    `;
    return base("Bienvenido al boletín de EduGreen", body);
  }
}
